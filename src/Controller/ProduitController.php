...
class ProduitController extends Controller
{
    ...
    /**
     * @Route("/supp/{id}", name="DeleteProd")
     */
    public function DeleteProd($id , ProduitRepository  $repository )
    {
     ...
     * param ProduitRepository $repository
     * @return Response
     * @Route("afficherPro", name="afficherPro")
     */
    ...
    /**
     * @Route("detailproduct/{id}", name="produit_detail")
     */
