...
function newpost()
{
	...
	for(var i=0;i<10;i++)
	{
		...
		para.className="name";
		var text1=document.createTextNode("Inès_Msallem");
		...
		var text3=document.createTextNode("Tunisian culture is a product of more than three thousand years of history and an important multi-ethnic influx. ... Among these cultures were the Carthaginian – their native civilization, Roman (Roman Africans), Vandal, Jewish, Christian, Arab, Islamic, Turkish, Europeans, and French, in addition to native Amazigh.");
...
// changing imagebutton color on hover
 function onbuttoncolor()
 {
 	...
 	on.style.backgroundColor = "#CB7F4A";
...
// chaging imagebutton color on hover out
 function outbuttoncolor()
 {
 	...
 	out.style.backgroundColor = "#CB7F4A";
